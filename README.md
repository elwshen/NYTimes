...
<img src='http://i.imgur.com/VFSrzU8.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

I spent the most time working on the search filters.  Subsequent searches do have selected filters applied to the result, but the date picker does not show the selected date after the user navigates away from the dialog.  
